...
case class Message(id: Long = 0, groupId: String, topicId: Long, userId: Long, date: DateTime, text: String)

trait MessagesComponent extends WithMyDriver {

  import driver.simple._

  class MessagesTable(tag: Tag) extends MyPostgresDriver.Table[Message](tag, "Message") {
    ...
    def * = (id, groupId, topicId, userId, date, text) <>(Message.tupled, Message.unapply)
  }
