...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventsChatActions = __webpack_require__(181);
	
	var _eventsChatActions2 = _interopRequireDefault(_eventsChatActions);
	
	var _componentsSideBar = __webpack_require__(182);
	
	var _componentsSideBar2 = _interopRequireDefault(_componentsSideBar);
	
	var _componentsIntegrationsPane = __webpack_require__(187);
	
	var _componentsIntegrationsPane2 = _interopRequireDefault(_componentsIntegrationsPane);
	
	var _componentsTopicBar = __webpack_require__(188);
	
	var _componentsTopicBar2 = _interopRequireDefault(_componentsTopicBar);
	
	var _componentsMessageBar = __webpack_require__(195);
	...
	var App = _react2['default'].createClass({
	    ...
	    mixins: [_reflux2['default'].connect(_eventsChatStore2['default'], 'store')],
	    ...
	    openSocket: function openSocket() {
	        ...
	        socket.onmessage = function (message) {
	            if (message.data != JSON.stringify("Tack")) {
	                ...
	                if (data.topicId) {
	                    _eventsChatActions2['default'].newMessage(data);
	                } else if (data.newGroup) {
	                    _eventsChatActions2['default'].newGroup(data.newGroup);
	                } else if (data.newUser) {
	                    // TODO newUser
	                    _eventsChatActions2['default'].newUser(data.newUser);
	                } else if (data.enableIntegration) {
	                    _eventsChatActions2['default'].enableIntegration(data.enableIntegration);
	                } else if (data.disableIntegration) {
	                    _eventsChatActions2['default'].enableIntegration(data.disableIntegration);
	                } else if (data.id && !data.toUser) {
	                    _eventsChatActions2['default'].newTopic(data);
	                } else if (data.toUser) {
	                    _eventsChatActions2['default'].newMessage(data);
	                }
	            }
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_componentsIntegrationsPane2['default'], null),
	            _react2['default'].createElement(_componentsTopicBar2['default'], null),
	            _react2['default'].createElement(_componentsMessageBar2['default'], null)
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _chatActions = __webpack_require__(181);
	
	var _chatActions2 = _interopRequireDefault(_chatActions);
	
	var ChatStore = _reflux2['default'].createStore({
	    listenables: [_chatActions2['default']],
	    ...
	    onSelectGroup: function onSelectGroup(group) {
	        var self = this;
	        ...
	        $.ajax({
	            context: this,
	            type: "GET",
	            url: "/json/user/" + _global.user.id + "/topics" + (group ? "/" + group.id : ""),
	    ...
	    onNewGroup: function onNewGroup(group, select) {
	    ...
	    onNewUser: function onNewUser(user) {
	        this.state.users.push(user);
	        this.trigger(this.state);
	    },
	
	    onEnableIntegration: function onEnableIntegration(integration) {
	        this.state.integrations[integration] = true;
	        this.trigger(this.state);
	    },
	
	    onDisableIntegration: function onDisableIntegration(integration) {
	        delete this.state.integrations[integration];
	        this.trigger(this.state);
	    },
	
	    onShowIntegrations: function onShowIntegrations(initial) {
	    ...
	    onNewTopic: function onNewTopic(topic, select) {
	        if ((!this.state.selectedGroup || this.state.selectedGroup.id == topic.group.id) && this.state.topics.filter(function (m) {
	    ...
	    onNewMessage: function onNewMessage(message) {
	        if ((this.state.selectedTopic && this.state.selectedTopic.id == message.topicId || this.state.selectedUser && (this.state.selectedUser.id == message.toUser.id && _global.user.id == message.user.id || this.state.selectedUser.id == message.user.id && _global.user.id == message.toUser.id)) && this.state.messages.filter(function (m) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _groupPane = __webpack_require__(183);
	
	var _groupPane2 = _interopRequireDefault(_groupPane);
	...
	var SideBar = _react2['default'].createClass({
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_groupPane2['default'], null)
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newGroupButton = __webpack_require__(184);
	
	var _newGroupButton2 = _interopRequireDefault(_newGroupButton);
	
	var _settingsButton = __webpack_require__(186);
	
	var _settingsButton2 = _interopRequireDefault(_settingsButton);
	
	var GroupPane = _react2['default'].createClass({
	    displayName: 'GroupPane',
	
	    mixins: [_reflux2['default'].connect(_eventsChatStore2['default'], 'store')],
	
	    onGroupClick: function onGroupClick(group) {
	        _eventsChatActions2['default'].selectGroup(group);
	    },
	    ...
	    render: function render() {
	        ...
	        var userItems = self.state.store.users.map(function (user) {
	            ...
	            return _react2['default'].createElement(
	                'li',
	                { 'data-user': user.id, className: userClass,
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'li',
	                { id: 'all-groups', className: allGroupsClass,
	            ...
	            groupItems,
	            _react2['default'].createElement(_newGroupButton2['default'], null),
	            integrationItems,
	            _react2['default'].createElement(_settingsButton2['default'], { selected: self.state.store.displaySettings }),
	            userItems
	        );
	    }
	});
	
	exports['default'] = GroupPane;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newGroupDialog = __webpack_require__(185);
	
	var _newGroupDialog2 = _interopRequireDefault(_newGroupDialog);
	
	var NewGroupButton = _react2['default'].createClass({
	    displayName: 'NewGroupButton',
	
	    componentDidMount: function componentDidMount() {
	        $(_reactDom2['default'].findDOMNode(this)).popover({
	            react: true,
	            content: _react2['default'].createElement(_newGroupDialog2['default'], null)
	...
	exports['default'] = NewGroupButton;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewGroupDialog = _react2['default'].createClass({
	    displayName: 'NewGroupDialog',
	
	    createGroup: function createGroup() {
	        var groupName = _reactDom2['default'].findDOMNode(this.refs.groupName).value.trim();
	        if (groupName && !/\s/.test(groupName)) {
	            $.ajax({
	                ...
	                success: function success(group) {
	                    _eventsChatActions2['default'].newGroup(group, true);
	                },
	                fail: function fail(e) {
	                    console.error(e);
	                }
	            ...
	            _reactDom2['default'].findDOMNode(this.refs.groupName).value = "";
	        }
	    },
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            'div',
	            { className: 'new-group-popover' },
	            _react2['default'].createElement('input', { ref: 'groupName', type: 'text', className: 'group-name', placeholder: 'Name...',
	                onKeyPress: this.onKeyPress }),
	            _react2['default'].createElement(
	                'div',
	                { className: 'group-label' },
	                'Must be 21 characters or less. No spaces or periods.'
	            ),
	            _react2['default'].createElement(
	                'a',
	                { className: 'btn btn-default btn-sm', onClick: this.createGroup },
	                'Create group'
	            )
	        );
	    }
	...
	exports['default'] = NewGroupDialog;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SettingsButton = _react2['default'].createClass({
	    displayName: 'SettingsButton',
	
	    onClick: function onClick() {
	        _eventsChatActions2['default'].showIntegrations();
	    },
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement(
	            'li',
	            { id: 'integrations-button', onClick: self.onClick.bind(self, undefined), className: className },
	            'Settings'
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IntegrationsPane = _react2['default'].createClass({
	    displayName: 'IntegrationsPane',
	    ...
	    render: function render() {
	        var integrationItems = this.state.store.integrations.map(function (integration) {
	            ...
	            return _react2['default'].createElement(
	                'div',
	                { className: 'row', key: integration.id },
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'col-md-8' },
	                    integration.name
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        _react2['default'].createElement('input', { type: 'checkbox', 'data-size': 'mini', defaultChecked: checked,
	        ...
	        return _react2['default'].createElement(
	            'div',
	            { id: 'integration-pane', style: { display: this.state.store.displaySettings ? "" : "none" } },
	            _react2['default'].createElement(
	                'h5',
	                null,
	                'Integrations'
	...
	window.setInterval(function () {
	    $("input[type='checkbox']").bootstrapSwitch().off('switchChange.bootstrapSwitch').on('switchChange.bootstrapSwitch', function (event, state) {
	        var integrationId = $(this).attr("data-integration-id");
	        if (state) {
	            window.location.replace("/integration/" + integrationId + "/auth?id=" + integrationId + "&redirectUrl=" + encodeURIComponent(document.location.href));
	        } else {
	            $.ajax({
	                context: this,
	                type: "GET",
	...
	exports['default'] = IntegrationsPane;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchPane = __webpack_require__(189);
	
	var _searchPane2 = _interopRequireDefault(_searchPane);
	
	var _newTopicPane = __webpack_require__(190);
	
	var _newTopicPane2 = _interopRequireDefault(_newTopicPane);
	
	var _topicPane = __webpack_require__(191);
	
	var _topicPane2 = _interopRequireDefault(_topicPane);
	
	var _eventsChatStore = __webpack_require__(180);
	
	var _eventsChatStore2 = _interopRequireDefault(_eventsChatStore);
	
	var TopicBar = _react2['default'].createClass({
	    displayName: 'TopicBar',
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            'div',
	            { id: 'topic-bar', style: { display: this.state.store.selectedUser || this.state.store.displaySettings ? "none" : "" } },
	            _react2['default'].createElement(_searchPane2['default'], null),
	            _react2['default'].createElement(_newTopicPane2['default'], null),
	            _react2['default'].createElement(_topicPane2['default'], null)
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchPane = _react2["default"].createClass({
	    displayName: "SearchPane",
	
	    render: function render() {
	        return _react2["default"].createElement(
	            "div",
	            { id: "search-pane", className: "form-inline" },
	            _react2["default"].createElement(
	                "div",
	                { className: "btn-group" },
	                _react2["default"].createElement("input", { id: "search", type: "text", className: "search-query",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NewTopicPane = _react2['default'].createClass({
	    displayName: 'NewTopicPane',
	
	    mixins: [_reflux2['default'].connect(_eventsChatStore2['default'], 'store')],
	
	    onClick: function onClick() {
	        if (this.state.store.selectedGroup) {
	            _eventsChatActions2['default'].selectTopic();
	        }
	    },
	    ...
	    render: function render() {
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'a',
	                { id: 'new-topic', className: newTopicClass,
	                    onClick: this.onClick },
	                _react2['default'].createElement('span', { id: 'plus' }),
	                _react2['default'].createElement(
	                    'span',
	                    null,
	                    'New topic'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _topicItem = __webpack_require__(192);
	
	var _topicItem2 = _interopRequireDefault(_topicItem);
	
	var _integrationTopicItem = __webpack_require__(194);
	
	var _integrationTopicItem2 = _interopRequireDefault(_integrationTopicItem);
	
	var _eventsChatStore = __webpack_require__(180);
	
	var _eventsChatStore2 = _interopRequireDefault(_eventsChatStore);
	
	var TopicPane = _react2['default'].createClass({
	    displayName: 'TopicPane',
	    ...
	    render: function render() {
	        ...
	        if (self.state.store.integrationTopics) {
	            ...
	            topicItems = self.state.store.topics.map(function (t) {
	                return _react2['default'].createElement(_topicItem2['default'], { topic: t.topic,
	                    selected: self.state.store.selectedTopic && self.state.store.selectedTopic.id == t.topic.id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopicItem = _react2['default'].createClass({
	    displayName: 'TopicItem',
	
	    onClick: function onClick(topic) {
	        _eventsChatActions2['default'].selectTopic(topic);
	    },
	    ...
	    render: function render() {
	        ...
	        if (self.props.showGroup) {
	            ...
	            groupRef = _react2['default'].createElement(
	                'span',
	                null,
	                'in #',
	                _react2['default'].createElement(
	                    ...
	                    {
	                        className: 'group' },
	                    self.props.topic.group.name
	                )
	            );
	        }
	        return _react2['default'].createElement(
	            'li',
	            { 'data-topic': self.props.topic.id, className: topicClass,
	                onClick: self.onClick.bind(self, self.props.topic) },
	            _react2['default'].createElement(
	                'div',
	                { className: 'text' },
	                self.props.topic.text
	            ),
	            _react2['default'].createElement(
	                'div',
	                { className: 'info' },
	                ...
	                _react2['default'].createElement(
	                    ...
	                    { className: 'pretty date',
	                        'data-date': self.props.topic.date },
	                    prettyDate
	                )
	            )
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IntegrationTopicItem = _react2['default'].createClass({
	    displayName: 'IntegrationTopicItem',
	
	    onClick: function onClick(integration, group, topic) {
	        _eventsChatActions2['default'].selectIntegrationTopic(integration, group, topic);
	    },
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'span',
	                    { className: 'author' },
	                    self.props.topic.integrationUser.name
	                ),
	                ' ',
	                groupRef,
	                ' ',
	...
	exports['default'] = IntegrationTopicItem;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _messageItem = __webpack_require__(196);
	...
	var MessageBar = _react2['default'].createClass({
	    displayName: 'MessageBar',
	
	    mixins: [_reflux2['default'].connect(_eventsChatStore2['default'], 'store')],
	
	    componentDidUpdate: function componentDidUpdate() {
	        var messageRoll = $(_reactDom2['default'].findDOMNode(this.refs.messageRoll));
	    ...
	    onInputKeyPress: function onInputKeyPress(event) {
	        var self = this;
	        var input = _reactDom2['default'].findDOMNode(self.refs.input);
	            ...
	            if (self.state.store.selectedUser) {
	                ...
	                $.ajax({
	                    ...
	                    success: function success(id) {
	                        ...
	                        _eventsChatActions2['default'].newMessage(newDirectMessage);
	                    },
	                    fail: function fail(e) {
	                        console.error(e);
	                    }
	                ...
	                $.ajax({
	                    ...
	                    success: function success(id) {
	                        ...
	                        if (newMessage.topicId) {
	                            ...
	                            _eventsChatActions2['default'].newMessage(m);
	                        } else {
	                            _eventsChatActions2['default'].newTopic(m, true);
	                        }
	                    },
	                    fail: function fail(e) {
	                        console.error(e);
	    ...
	    render: function render() {
	        ...
	        if (self.state.store.selectedUser) {
	            userHeader = _react2['default'].createElement(
	                'div',
	                { id: 'message-roll-header' },
	                _react2['default'].createElement(
	                    'li',
	                    { className: 'clearfix topic' },
	                    _react2['default'].createElement('img', { className: 'img avatar pull-left', src: self.state.store.selectedUser.avatar }),
	                    _react2['default'].createElement(
	                        'div',
	                        { className: 'details' },
	                        _react2['default'].createElement(
	                            ...
	                            _react2['default'].createElement(
	                                'span',
	                                { className: 'user' },
	                                self.state.store.selectedUser.name
	                            )
	                        )
	                    )
	                )
	        ...
	        return(
	            ...
	            _react2['default'].createElement(
	                'div',
	                { id: 'message-bar', style: { left: this.state.store.selectedUser ? "200px" : "550px", display: this.state.store.displaySettings ? "none" : "" } },
	                _react2['default'].createElement(
	                    'div',
	                    { id: 'message-pane' },
	                    _react2['default'].createElement(
	                        'div',
	                        { id: 'message-roll', ref: 'messageRoll' },
	                        messageItems
	                    ),
	                    userHeader
	                ),
	                _react2['default'].createElement('textarea', { id: 'input', ref: 'input', autoComplete: 'off',
	...
	var MessageItem = _react2['default'].createClass({
	    ...
	    render: function render() {
	        ...
	        if (!self.props.sameUser) {
	            avatar = _react2['default'].createElement('img', { className: 'img avatar pull-left', src: self.props.message.user.avatar });
	        ...
	        return _react2['default'].createElement(
	            'li',
	            { className: className, 'data-user': self.props.message.user.id },
	            avatar,
	            _react2['default'].createElement(
	                'div',
	                { className: 'details' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	$.fn.popover.Constructor.prototype.setContent = function () {
	    ...
	    if (!$tip.find('.popover-content').html()) {
	        ...
	        if (title) {
	            _reactDom2['default'].render(title, $title[0]);
	        } else {
	            $title.hide();
	        }
	
	        _reactDom2['default'].render(content, $tip.find('.popover-content')[0]);
	    }
	};
